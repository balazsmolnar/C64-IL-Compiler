...
Enemy_Init 
  ...
  ; OPT   #ldfld8 4 ; Ldfld
    ...
    #and8 ; And
  ; OPT   #stack_push_int8 0 ; Ldc_i4_0
  ; OPT   #branch_less_equal8 Enemy_Init_79 ; Ble_s
    #branch_less_equal_const 0, Enemy_Init_79 ; Nop
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 87 ; Ldc_i4_s
    jsr Enemy_set_Y ; Call
Enemy_Init_79:    #locals_push_value8 1 ; Ldarg_0
  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 4 ; Ldfld
    #pushfld8 4 ; Nop
  ...
  ; OPT   #ldfld8 6 ; Ldfld
    #pushfld8 6 ; Nop
    #branch_false Enemy_Init_131 ; Brfalse_s
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int16 0 ; Ldc_i4_0
    ; conv ; Conv_i8
    jsr Enemy_set_X ; Call
    jmp Enemy_Init_143 ; Br_s
Enemy_Init_131:    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int16 316 ; Ldc_i4
    ; conv ; Conv_i8
    jsr Enemy_set_X ; Call
Enemy_Init_143:  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 7 ; Ldfld
    #pushfld8 7 ; Nop
    #branch_false Enemy_Init_180 ; Brfalse_s
  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 6 ; Ldfld
    #pushfld8 6 ; Nop
    #branch_false Enemy_Init_180 ; Brfalse_s
...
Enemy_Move_39:  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 6 ; Ldfld
    #pushfld8 6 ; Nop
    #branch_false Enemy_Move_90 ; Brfalse_s
    #locals_push_value8 1 ; Ldarg_0
    #locals_push_value8 1 ; Ldarg_0
    ...
    #stack_push_int16 316 ; Ldc_i4
    ; conv ; Conv_i8
    #branch_not_equal16 Enemy_Move_128 ; Bne_un_s
    #locals_push_value8 1 ; Ldarg_0
  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 4 ; Ldfld
    #pushfld8 4 ; Nop
...
Enemy_Move_90:    #locals_push_value8 1 ; Ldarg_0
    #locals_push_value8 1 ; Ldarg_0
    jsr Enemy_get_X ; Call
    #stack_push_int16 4 ; Ldc_i4_4
    ; conv ; Conv_i8
  ...
  ; OPT   #ldfld8 4 ; Ldfld
    #pushfld8 4 ; Nop
    jsr Enemy_Init ; Call
Enemy_Move_128:    #locals_push_value8 1 ; Ldarg_0
...
Enemy_SetFrame_39:  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 5 ; Ldfld
    #pushfld8 5 ; Nop
  ; OPT   #stack_push_pointer string_1879048251 ; Ldstr
  ; OPT   jsr C64Address_FromLabel ; Call
...
Enemy_SetFrame_61:  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 5 ; Ldfld
    #pushfld8 5 ; Nop
  ; OPT   #stack_push_pointer string_1879048281 ; Ldstr
  ; OPT   jsr C64Address_FromLabel ; Call
...
Enemy_SetFrame_83:  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 5 ; Ldfld
    #pushfld8 5 ; Nop
  ; OPT   #stack_push_pointer string_1879048311 ; Ldstr
  ; OPT   jsr C64Address_FromLabel ; Call
...
Enemy_SetFrame_105:  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 5 ; Ldfld
    #pushfld8 5 ; Nop
  ; OPT   #stack_push_pointer string_1879048341 ; Ldstr
  ; OPT   jsr C64Address_FromLabel ; Call
