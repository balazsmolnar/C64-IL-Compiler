...
Player_SetFrame_229:    jmp Player_SetFrame_545 ; Br
...
Player_SetFrame_389:    nop ; Nop
  ...
  ; OPT   #ldfld 4 ; Ldfld
    ...
    #locals_push_value_8 11 ; Ldloc_s
    #branch_false Player_SetFrame_429 ; Brfalse_s
  ; OPT   #locals_push_value_8 1 ; Ldarg_0
  ; OPT   #ldfld 11 ; Ldfld
    #pushfld 11 ; Nop
  ; OPT   #stack_push_pointer string_1879048517 ; Ldstr
  ; OPT   jsr C64Address_FromLabel ; Call
    ...
    jsr Sprite_set_DataBlock ; Callvirt
    nop ; Nop
    jmp Player_SetFrame_544 ; Br_s
Player_SetFrame_429:  ; OPT   #locals_push_value_8 1 ; Ldarg_0
  ; OPT   #ldfld 4 ; Ldfld
    #pushfld 4 ; Nop
    #stack_push_int 1 ; Ldc_i4_1
    #compareEqual ; Ceq
    #locals_pull_value_8 12, 0 ; Stloc_s
    #locals_push_value_8 12 ; Ldloc_s
    #branch_false Player_SetFrame_468 ; Brfalse_s
  ; OPT   #locals_push_value_8 1 ; Ldarg_0
  ; OPT   #ldfld 11 ; Ldfld
    #pushfld 11 ; Nop
  ...
  ; OPT   jsr C64Address_FromLabel ; Call
    ...
    nop ; Nop
    jmp Player_SetFrame_544 ; Br_s
Player_SetFrame_468:  ; OPT   #locals_push_value_8 1 ; Ldarg_0
  ; OPT   #ldfld 4 ; Ldfld
    #pushfld 4 ; Nop
    #stack_push_int 2 ; Ldc_i4_2
    #compareEqual ; Ceq
    ...
    #locals_push_value_8 13 ; Ldloc_s
    #branch_false Player_SetFrame_507 ; Brfalse_s
  ; OPT   #locals_push_value_8 1 ; Ldarg_0
  ; OPT   #ldfld 11 ; Ldfld
    #pushfld 11 ; Nop
...
Player_SetFrame_507:  ; OPT   #locals_push_value_8 1 ; Ldarg_0
  ; OPT   #ldfld 4 ; Ldfld
    ...
    #branch_false Player_SetFrame_544 ; Brfalse_s
  ; OPT   #locals_push_value_8 1 ; Ldarg_0
  ; OPT   #ldfld 11 ; Ldfld
    #pushfld 11 ; Nop
  ...
  ; OPT   jsr C64Address_FromLabel ; Call
    ...
    jsr Sprite_set_DataBlock ; Callvirt
    nop ; Nop
Player_SetFrame_544:    nop ; Nop
Player_SetFrame_545:    #method_exit 16, [] ; Ret
