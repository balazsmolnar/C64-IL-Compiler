...
PlayerStats_Draw_6:  ; OPT   #stack_push_int 0 ; Ldc_i4_0
...
PlayerStats_Draw_10:  ; OPT   #stack_push_pointer string_1879049213 ; Ldstr
  ...
  ; OPT   #locals_pull_value_8 4, 0 ; Stloc_2
    #inc_var 4 ; Nop
PlayerStats_Draw_63:    #locals_push_value_8 4 ; Ldloc_2
  ; OPT   #stack_push_int 40 ; Ldc_i4_s
  ; OPT   #branch_less_unsigned PlayerStats_Draw_10 ; Blt_un_s
  ...
  ; OPT   #locals_pull_value_8 3, 0 ; Stloc_1
    #inc_var 3 ; Nop
PlayerStats_Draw_72:    #locals_push_value_8 3 ; Ldloc_1
  ; OPT   #stack_push_int 2 ; Ldc_i4_2
  ; OPT   #branch_less_unsigned PlayerStats_Draw_6 ; Blt_un_s
