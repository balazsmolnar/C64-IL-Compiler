...
.string_1879048299 !pet "a is not alive!",0
.string_1879048331 !pet "a is still alive!",0
.string_1879048367 !pet "b3.id != 4",0
.string_1879048389 !pet "b3.child.id != 5",0
.string_1879048423 !pet "b3.child.child.id != 4",0
.string_1879048469 !pet "b1 is not alive!",0
.string_1879048503 !pet "b2 is not alive!",0
.string_1879048537 !pet "b3 is not alive!",0
.string_1879048571 !pet "a1 is alive!",0
.string_1879048597 !pet "a2 is alive!",0
.string_1879048623 !pet "a3 is alive!",0
