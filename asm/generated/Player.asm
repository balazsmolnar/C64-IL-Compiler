...
Player_Move_82:  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 9 ; Ldfld
    #pushfld8 9 ; Nop
    #branch_true Player_Move_162 ; Brtrue_s
    #locals_push_value8 1 ; Ldarg_0
    jsr Player_get_IsJump ; Call
    #branch_false Player_Move_162 ; Brfalse_s
  ...
  ; OPT   #ldfld8 12 ; Ldfld
    #pushfld8 12 ; Nop
    #branch_false Player_Move_148 ; Brfalse_s
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 1 ; Ldc_i4_1
    #stfld8 10 ; Stfld
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 0 ; Ldc_i4_0
    #stfld8 12 ; Stfld
Player_Move_148:    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 1 ; Ldc_i4_1
    #stfld8 9 ; Stfld
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 0 ; Ldc_i4_0
    #stfld8 7 ; Stfld
Player_Move_162:  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 9 ; Ldfld
    #pushfld8 9 ; Nop
    #branch_false Player_Move_230 ; Brfalse_s
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 117 ; Ldc_i4_s
  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 2 ; Ldfld
  ...
  ; OPT   #branch_not_equal8 Player_Move_230 ; Bne_un_s
    #branch_not_equal_const 16, Player_Move_230 ; Nop
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 0 ; Ldc_i4_0
    #stfld8 9 ; Stfld
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 0 ; Ldc_i4_0
    #stfld8 10 ; Stfld
Player_Move_230:    #locals_push_value8 1 ; Ldarg_0
    jsr Player_get_IsLeft ; Call
    #branch_false Player_Move_282 ; Brfalse_s
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 1 ; Ldc_i4_1
    #stfld8 8 ; Stfld
  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 12 ; Ldfld
    #pushfld8 12 ; Nop
    #branch_true Player_Move_282 ; Brtrue_s
    #locals_push_value8 1 ; Ldarg_0
    #locals_push_value8 1 ; Ldarg_0
    jsr Player_get_X ; Call
  ...
  ; OPT   #ldfld8 6 ; Ldfld
    ...
    #add8 ; Add
    #stfld8 6 ; Stfld
Player_Move_282:    #locals_push_value8 1 ; Ldarg_0
    jsr Player_get_IsRight ; Call
    #branch_false Player_Move_334 ; Brfalse_s
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 0 ; Ldc_i4_0
    #stfld8 8 ; Stfld
  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 12 ; Ldfld
    #pushfld8 12 ; Nop
    #branch_true Player_Move_334 ; Brtrue_s
    #locals_push_value8 1 ; Ldarg_0
    #locals_push_value8 1 ; Ldarg_0
    jsr Player_get_X ; Call
    #stack_push_int16 2 ; Ldc_i4_2
  ...
  ; OPT   #ldfld8 6 ; Ldfld
    ...
    #add8 ; Add
    #stfld8 6 ; Stfld
Player_Move_334:  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 6 ; Ldfld
    #pushfld8 6 ; Nop
  ; OPT   #stack_push_int8 4 ; Ldc_i4_4
  ; OPT   #branch_not_equal8 Player_Move_350 ; Bne_un_s
    #branch_not_equal_const 4, Player_Move_350 ; Nop
    #locals_push_value8 1 ; Ldarg_0
    #stack_push_int8 0 ; Ldc_i4_0
    #stfld8 6 ; Stfld
Player_Move_350:    #locals_push_value8 1 ; Ldarg_0
    jsr Player_get_Y ; Call
  ; OPT   #stack_push_int8 117 ; Ldc_i4_s
  ; OPT   #branch_not_equal8 Player_Move_393 ; Bne_un_s
    #branch_not_equal_const 117, Player_Move_393 ; Nop
  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 10 ; Ldfld
    #pushfld8 10 ; Nop
    #branch_true Player_Move_393 ; Brtrue_s
  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld8 1 ; Ldfld
    #pushfld8 1 ; Nop
  ; OPT   #locals_push_value8 1 ; Ldarg_0
  ; OPT   #ldfld16 3 ; Ldfld
    ...
    #branch_false Player_Move_393 ; Brfalse_s
    #locals_push_value8 1 ; Ldarg_0
    jsr Player_Die ; Call
Player_Move_393:    #locals_push_value8 1 ; Ldarg_0
...
Player_get_IsLeft 
    ...
    #and8 ; And
  ; OPT   #stack_push_int8 4 ; Ldc_i4_4
  ; OPT   #compareEqual8 ; Ceq
    compareEqual_const8 4 ; Nop
    #method_exit 3, [] ; Ret
Player_get_IsLeft_29:    #stack_push_int8 1 ; Ldc_i4_1
    #method_exit 3, [] ; Ret
...
Player_get_IsRight 
    ...
    #stack_push_int8 8 ; Ldc_i4_8
    #and8 ; And
  ; OPT   #stack_push_int8 8 ; Ldc_i4_8
  ; OPT   #compareEqual8 ; Ceq
    compareEqual_const8 8 ; Nop
    #method_exit 3, [] ; Ret
Player_get_IsRight_29:    #stack_push_int8 1 ; Ldc_i4_1
    #method_exit 3, [] ; Ret
...
Player_get_IsJump 
  ...
  ; OPT   #stack_push_int8 16 ; Ldc_i4_s
  ; OPT   #compareEqual8 ; Ceq
    compareEqual_const8 16 ; Nop
    #method_exit 3, [] ; Ret
Player_get_IsJump_32:    #stack_push_int8 1 ; Ldc_i4_1
    #method_exit 3, [] ; Ret
